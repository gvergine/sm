# from https://github.com/Yubico/yubihsm-shell/blob/master/cmake/gengetopt.cmake
...
macro (add_gengetopt_files _basename)
  ...
  set (_ggo_c ${CMAKE_CURRENT_BINARY_DIR}/${_basename}.c)
  set (_ggo_h ${CMAKE_CURRENT_BINARY_DIR}/${_basename}.h)
